...
#Reads hit count from disk, increment or write it, and returns it
...
?>
        ...
        <p>Welcome to Jessica's GRE vocab word of the day page! Each time you
        visit, a random word and its definition will be shown.
        </p>
